<template>
  <div style="width: 100%;">
    <label for="range">Images per Row: </label>
    <input id="range" type="range" min="1" max="10" v-model="perRow" />
    <br />
    <label for="smooth">smoothResize: </label>
    <input id="smooth" type="checkbox" v-model="options.smoothResize" />
    <br />
    <label for="border">border: </label>
    <input id="border" type="text" v-model="options.border" />
    <br />
    <label for="toggle">toggleTextOnClick: </label>
    <input id="toggle" type="checkbox" v-model="options.toggleTextOnClick" />
    <br />
    <label for="vertical">vertical: </label>
    <input id="vertical" type="checkbox" v-model="options.vertical" />
    <br />

    <Gallery :images="images" :per-row="perRow" :options="options" />
  </div>
</template>
<script>
